...
class ExchangeScreen extends React.Component<Props, State> {
  ...
  openAssetOptions = (type: 'sell' | 'buy') => {
  ...
  openSellOptions = () => this.openAssetOptions(SELL)
  openBuyOptions = () => this.openAssetOptions(BUY)
  ...
  getFromInput = () => {
    ...
    return (
      <TextInput
        ...
        asset={fromAsset}
        onAssetPress={this.openSellOptions}
  ...
  getToInput = () => {
    ...
    return (
      <TextInput
        ...
        onBlur={this.blurFromInput}
        asset={toAsset}
        onAssetPress={this.openBuyOptions}
