...
export const usernameSelector: Selector<void | string> =
  createSelector(userSelector, ({ username }: User) => username);

const lastUserUpdateTimeSelector: Selector<void | number> =
  createSelector(userSelector, ({ lastUpdateTime }: User) => lastUpdateTime);

const profileImageSelector: Selector<void | string> =
  createSelector(userSelector, ({ profileImage }: User) => profileImage);
...
export const walletIdSelector: Selector<string> =
  createSelector(userSelector, ({ walletId }: User): string => walletId);
